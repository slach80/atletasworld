...
from .admin_views import (
    ...
    owner_clients, owner_client_detail, owner_client_approve, owner_client_reject, owner_client_settle_bookings, owner_client_toggle_select_invite, owner_package_assign, owner_package_adjust, owner_players, owner_player_detail,
...
urlpatterns = [
    ...
    path('owner-portal/clients/<int:pk>/toggle-select-invite/', owner_client_toggle_select_invite, name='owner_client_toggle_select_invite'),
    path('owner-portal/clients/<int:pk>/settle-bookings/', owner_client_settle_bookings, name='owner_client_settle_bookings'),
