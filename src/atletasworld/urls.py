...
from .admin_views import (
    ...
    owner_clients, owner_client_detail, owner_client_approve, owner_client_reject, owner_client_settle_bookings, owner_package_assign, owner_package_adjust, owner_players, owner_player_detail,
